...
internal sealed class EmployeeService : IEmployeeService
{
    ...
    public async Task<EmployeeDto> GetEmployeeAsync(Guid companyId, Guid id, bool trackChanges)
    {
        ...
        var employeeDb = await GetEmployeeFromCompanyAndCheckIfItExists(companyId, id, trackChanges);
        ...
        bool compTrackChanges, bool empTrackChanges)
    {
        ...
        var employeeDb = await GetEmployeeFromCompanyAndCheckIfItExists(companyId, id, empTrackChanges);
    ...
    private async Task<Employee> GetEmployeeFromCompanyAndCheckIfItExists(Guid companyId, Guid id, bool trackChanges)
    {
